...
namespace _1367B
{
    class Program
    {
        ...
        {
            int testCases = Convert.ToInt32(Console.ReadLine()), fix, fix1;
            ...
            for(int i = 0; i<testCases; i++)
            {
                ...
                {
                    if(j%2 == 0 && int.Parse(arr[j])%2 == 1)
                    {
                        fix++;
                    }else if(j % 2 == 1 && int.Parse(arr[j])%2 == 0)
                    {
                        fix1++;
                    }
                    //if (j%2 != int.Parse(arr[j]) % 2)
                    //{
                    //    fix++;
                    //}
                }
